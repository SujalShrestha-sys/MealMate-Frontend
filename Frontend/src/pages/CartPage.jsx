...
const CartPage = () => {
  ...
  const { items, getCartTotal, updateQuantity, clearCart, fetchCart } =
    useCartStore();
      ...
      <main className="flex-1 pt-28 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-10">
            <Link
              to="/menu"
              className="inline-flex items-center gap-2 text-slate-500 hover:text-green-600 font-bold text-xs transition-colors mb-4 uppercase tracking-widest group"
            >
              <ArrowLeft
                size={14}
            ...
            <p className="text-slate-500 mt-2 font-medium">
              Review and refine your curated meals before checkout.
            </p>
          </div>
              ...
              {items.length > 0 ? (
                ...
                <div className="bg-white rounded-4xl p-12 text-center border border-dashed border-slate-200">
                  ...
                  <p className="text-slate-500 mb-8 max-w-xs mx-auto font-medium">
                    Your selection is currently empty. Head over to the menu to
                ...
                <div className="bg-white rounded-4xl p-8 border border-slate-100 shadow-sm sticky top-28">
                  ...
                  <div className="mt-8 p-4 bg-green-50/50 rounded-2xl border border-green-100/50">
                    <p className="text-[10px] text-green-700/70 leading-relaxed text-center font-medium">
                      Orders are handcrafted fresh for your selected pickup
                      timeline. Skip the queue and eat better.
                    </p>
                  </div>
                </div>
              </div>
